...
function Header() {
  return (
    <div>
      <header className="flex bg-woo-white fixed top-0 left-0 justify-between items-center font-Aeonik-Regular !p-5  md:!px-16 w-full">
        <Logo />
        <nav>
...
function Hero() {
  return (
    <div className="!mt-8 font-Aeonik-Regular !px-4 md:!px-16 grid items-center justify-center md:justify-start min-h-screen md:grid-cols-2">
      ...
      <div className="lg:w-108 md:w-4/5 hidden md:block h-2/3 justify-self-end float-end rounded-full bg-[url('../../public/images/young-woman-scanning-qr-code.jpg')] bg-cover bg-center"></div>
    </div>
  );
}
