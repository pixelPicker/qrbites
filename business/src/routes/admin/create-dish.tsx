...
export const Route = createFileRoute("/admin/create-dish")({
...
function RouteComponent() {
  const {appendDishes, menu}=  useMenuStore(s => s);
  ...
  const mutation = addDishMutation(navigate, appendDishes);
  useEffect(() => {
    if (!dishImageError) {
      return;
    }
  ...
  return (
    <div className="grid place-items-center font-Aeonik-Regular overflow-y-scroll h-full">
      <div className="max-w-[450px] !py-16">
        <h3 className="font-medium text-center text-3xl">
        ...
        >
          ...
          <div>
            <div className="flex items-center">
              <input className={checkboxClass} type="checkbox" name="isVeg" />
