...
import {
  createAccessToken,
  createRefreshToken,
} from "../../utilities/authTokens.js";
import { createClientUser } from "../../utilities/createClientUser.js";


const router = express.Router();

router.get("/auth/verify", authenticateAccessToken, authenticateRefreshToken, async (req: Request, res: Response) => {
