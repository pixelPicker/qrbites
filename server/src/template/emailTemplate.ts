  ...
  return `
      <div style="width: 100%;background-color: mediumseagreen;color: black;padding: 50px 25px;display: flex;justify-content: center;">
        <div style="display: grid;place-items: center;gap: 10px;width: 100%;">
          ...
          <a style="text-decoration: none;padding: 10px 6px;background-color: white;color: black; width: 100px;text-align: center;border-radius: 10px;" href="http://localhost:5173/auth/confirm-page?email=${email}&token=${verificationToken}&type=${type}" target="_blank" rel="noopener noreferrer">Confirm</a>
        </div>
      </div>
    `;
};
